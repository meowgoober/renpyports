...
image haru = ConditionSwitch(
    "persistent.epilogue == False", "haru.png",
    "persistent.epilogue == True", "haru ep",
)

image haru blush = ConditionSwitch(
    "persistent.epilogue == False", "haru blush.png",
    "persistent.epilogue == True", "haru ep blush",
)

image haru down = ConditionSwitch(
    "persistent.epilogue == False", "haru down.png",
    "persistent.epilogue == True", "haru ep down",
)

image haru ganba = ConditionSwitch(
    "persistent.epilogue == False", "haru ganba.png",
    "persistent.epilogue == True", "haru ep ganba",
)

image haru hmm = ConditionSwitch(
    "persistent.epilogue == False", "haru hmm.png",
    "persistent.epilogue == True", "haru ep hmm",
)

image haru panicked = ConditionSwitch(
    "persistent.epilogue == False", "haru panicked.png",
    "persistent.epilogue == True", "haru ep panicked",
)

image haru tsuyoki = ConditionSwitch(
    "persistent.epilogue == False", "haru tsuyoki.png",
    "persistent.epilogue == True", "haru ep tsuyoki",
)
